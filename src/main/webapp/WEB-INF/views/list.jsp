                    ...
                    <div class="item_info_container">
                        <div class="item_info">
                            ...
                            <div class="price_area">
                                <p class="price_1">${board.o_Total}</p>
                                <!-- ↑↑↑ 총 가격 ↑↑↑ -->
                                <!-- price_[index]값으로 포인트 계산되게 해놨습니다 -->
                                <!-- price_[index]로 리스트 생성되게 해주세요 -->
                                <!-- 이 주석은 지워주십숑 -->
                                <p>&nbsp;원</p>
                            </div>
                        </div>
                        <div class="benefit_and_delivery_process">
                            <div class="saving_point_area">
                                ...
                                <div class="saving_point_text">
                                    <p class="saving_point_1"></p>
                                    <!-- 총 가격에 값 들어가면 자동으로 계산되게 해놨습니다 -->
                                    <!-- saving_point_[index]로 리스트 생성되게 해주세요 -->
                                    <!-- 이 주석은 지워주십숑 -->
                                    <p>&nbsp;p</p>
                                </div>
                            </div>
                            <div class="delivery_porcess">
                                ...
                                <a href="#" class="delivery_porcess_link">
                                    <!-- ↑↑↑ 배송 추적 링크 입력 ↑↑↑ -->
                                    <p>배송추적</p>
                                </a>
                            </div>
                            <div class="detail">
                                ...
                                <a href="boardDetail?o_no=${board.o_no}" class="detail_link">
                                    <!-- ↑↑↑ 주문 명세 페이지 ↑↑↑ -->
                                    <p>보기▶</p>
                                </a>
                            </div>
...
<script rel="javascript" type="text/javascript" src="/resources/js/mypage.js"></script>
