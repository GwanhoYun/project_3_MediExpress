				...
				<div class="order_item_info_container">
					<div class="order_item_photo_container">
						<div class="item_photo">
							<img src="#" alt="주문 제품 이미지"
								onerror="this.onerror=null; this.src='img/이미지준비중.png';">
							<!-- ↑↑↑주문한 물건 이미지 출력↑↑↑ -->
						</div>
					</div>
					<div class="item_info_container">
						...
						<div class="benefit_and_delivery_process">
							...
							<div class="detail">
								...
								<a href="orderDetails?o_no=${board.o_no}&p_no=${board.p_no}"
									class="detail_link">자세히 보기</a>
...
<script rel="javascript" type="text/javascript"
	src="/resources/js/mypage.js"></script>
