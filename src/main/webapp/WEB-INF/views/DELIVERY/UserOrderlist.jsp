...
<body>
   <div class="container">
      ...
      <div class="order-info">
         ...
         <table>
            ...
            <c:if test="${empty loginUser}">
               ...
               <tr>
                  <th>승인 여부</th>
                  <td class="status">${board.o_permit ? '승인' : '미승인'}</td>
               </tr>
            </tbody>
         </table>
      </div>
      <div class="delivery-info">
         ...
         <button class="update-button" onclick="updateDeliveryStatus()">배송
            상태 업데이트</button>
      </div>
      ...
      <button class="print-button" onclick="printPage()">인쇄</button>
